...
public class EventsManagement implements CommandLineRunner {
	...
	private static final Logger logger = 
			...
			public void run(String... args) throws Exception {
				...
				crepository.save(new Client("client","$2a$10$QgUd1ravnkJucCBgV7Y5O.1S4toikspn0ODogXa31TOXplAUgaYne","Client","Client","77 190 33 90","client@gmail.com","Dakar"));

				prepository.save(new Prestataire("prestataire","$2a$10$QgUd1ravnkJucCBgV7Y5O.1S4toikspn0ODogXa31TOXplAUgaYne","Prestataire","78 191 33 90","prestataire@gmail.com","Ziguinchor",3,5,"Traiteur","Prestataire"));
			}
}