...
import SigninPres from './SigninPres'
...
const Toolbar = ({ setShowSignin, setShowComp, setState, state, who, id, showNotifications, setShowNotifications }) => {
              ...
              <div className="menu-item" onClick={toggleMenu2}>
                ...
                {menu2Open && (
                  <div className="dropdown-menu">
                    <div className="menu-item" onClick={() => handleSigninClick('home')}>
                      <FontAwesomeIcon icon={faHome} />
                      Home
                    </div>
                    <div className="menu-item" onClick={() => handleSigninClick('clients')}>Clients</div>
                    <div className="menu-item" onClick={() => handleSigninClick('prestataires')}>Prestataire</div>
                    <div className="menu-item" onClick={() => handleSigninClick('evenements')}>Événements</div>
                    <div className="menu-item" onClick={() => handleSigninClick('about')}>About</div>
                    <div className="menu-item" onClick={() => handleSigninClick('contact')}>Contact</div>
                  </div>
                )}
              </div>
            </div>
        ...
        return (
          <div className="toolbar">
            ...
            <div className="menu">
              ...
              <div className="menu-item" onClick={() => handleSigninClick('clients')}>
                Clients
              </div>
              <div className="menu-item" onClick={() => handleSigninClick('prestataires')}>
                Prestataire
              </div>
              <div className="menu-item" onClick={() => handleSigninClick('evenements')}>
                Événements
              </div>
              <div className="menu-item" onClick={() => handleSigninClick('about')}>
                About
              </div>
              <div className="menu-item" onClick={() => handleSigninClick('contact')}>
                Contact
              </div>
            </div>
            <div className="menu-right">
